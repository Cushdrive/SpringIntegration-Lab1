...
public class Shiporder {
    ...
    public String toString() {
        String returnVal = "Order ID: " + this.getOrderid() + "Order Person: " + this.getOrderperson()
                + "Order Item: " + this.getItem() + "Ship to: " + this.getShipto();
        return returnVal;
    }
    ...
    public static class Item {
        ...
        @Override
        public String toString() {
            String returnVal = "Note: " + this.getNote() + "Title: " + this.getTitle() + "Price: " + this.getPrice() + "Quantity: " + this.getQuantity();
            return returnVal;
        }
    }
    ...
    public static class Shipto {
        ...
        @Override
        public String toString() {
            String returnVal = "Address: " + this.getAddress() + "City: " + this.getCity() + "Country: " + this.getCountry() + "Name: " + this.getName();
            return returnVal;
        }
    }
